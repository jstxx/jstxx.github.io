'use strict';
      ...
      var setPage = function(page) {
        ...
        for (var i = (page-1) * streamsPerPage; i < (page * streamsPerPage) && i < Twitchapp.gamestreams.length; i++) {
          ...
          el.innerHTML = '<a href="'+Twitchapp.gamestreams[i].channel.url+'"><div class="stream-container">'+
        ...
        search: function(e){
          ...
          if(getQuerySelection){
            jsonp('https://api.twitch.tv/kraken/search/streams?q=' + getQuerySelection + '&callback=?')
              ...
              document.querySelector('.control-wrapper').style.visibility = "visible";
              ...
              document.querySelector('.control-wrapper').style.visibility = "hidden";
              console.log(err); 
              return;
            });
          }
